        ...
        vdom.children.forEach((virtualElement, index) => {
          ...
          if (key) {
            ...
            if (keyedDomElement) {
              ...
              if (oldDom.childNodes[index] && !oldDom.childNodes[index].isSameNode(keyedDomElement.domElement)) {
                oldDom.insertBefore(keyedDomElement.domElement, oldDom.childNodes[index]);
              }
