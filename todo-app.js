...
// vdom.render(<Heart style="color:red" />, root);
...
// vdom.render(<Greeting message="Good day!" />, root);

// setTimeout(() => {
//   alert("Re-rendering...");
//   vdom.render(<Greeting message="Good Night!" />, root);
// }, 4000);

// Stateful component
class Alert extends vdom.Component {
  constructor(props) {
    super(props);
    this.state = {
      title: "Default title",
...
//vdom.render(<Alert message="Are you sure?" />, root);

// Diffing / Reconciliation of two stateful components

class Stateful extends vdom.Component {
  constructor(props) {
    super(props);
    console.log(props);
  }
...
//vdom.render(<Stateful title="Task 1" />, root);

function update() {
  vdom.render(<Stateful title={new Date()} />, root);
}

class WishList extends vdom.Component {
  constructor(props) {
    super(props);
    this.state = {
      wish: {
...
class TodoItem extends vdom.Component {
  constructor(props) {
    super(props);
    this.logging = true;
  }
...
class TodoApp extends vdom.Component {
  constructor(props) {
    super(props);
